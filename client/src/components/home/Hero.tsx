...
const Hero = () => {
  return (
    <section className="relative overflow-hidden mb-10 rounded-3xl flex items-center min-h-[540px]">
      <img
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 mb-5 text-xs font-semibold text-orange-300 bg-orange-300/10 rounded-full">
