      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-right">
        ...
        <div className="flex items-center justify-between p-5 border-b border-app-border">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 pt-1 text-xs font-semibold bg-app-cream rounded-full">
              {items.length} items
            </span>
          </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className="size-6 rounded-full border border-app-border flex items-center justify-center hover:bg-app-cream transition-colors"
                      >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="text-app-red hover:text-app-red/80 transition-colors"
                      >
        ...
        {/* Footer */}
        {items.length > 0 && (
          <div className="p-5 border-app-border space-y-3">
            ...
            {deliveryFee > 0 && (
              <p className="text-xs text-app-text-light text-center">
                Add {currency}
                {(20 - cartTotal).toFixed(2)} more for free delivery
              </p>
            )}
