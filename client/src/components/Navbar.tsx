...
const Navbar = () => {
  const user: any = {name: "Charles", email: "charlesosango02@gmail.com", isAdmin: true};
    ...
    <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          {/* Search Bar */}
          <form onSubmit={handleSearch} className="hidden sm:flex flex-1 max-w-sm textxs sm:text-sm">
            ...
            <div className="relative">
              {user ? (
                ...
                <div className="flex-center gap-2">
                  <Link
                    to="/login"
                    className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 transition-colors rounded-full"
                  >
                    <UserIcon size={16} />
                    Sign In
                  </Link>
              ...
              {userMenuOpen && (
                <>
                  ...
                  >
                    <div className="absolute right-0 mt-27 w-50 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                      {user && (
