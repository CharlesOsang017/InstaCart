      ...
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-5 py-2 bg-app-green text-white text-sm font-medium rounded-xl hover:bg-app-green-light transition-colors"
          >
            Browse Products
          </button>
        </div>
          ...
          {steps.map((s, i) => (
            <div className="flex items-center gap-2">
              <button
                ...
                key={s.key}
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${step === s.key ? "bg-app-green text-white" : "bg-white text-app-light"}`}
              >
