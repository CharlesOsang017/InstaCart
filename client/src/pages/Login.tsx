...
import { BikeIcon, KeyIcon, Loader2Icon, MailIcon, UserIcon } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        ...
        <div className="relative text-center px-12">
          ...
          <p className="text-white/60 font-serif text-xl max-w-sm mx-auto">
            Fresh groceries and organic produce, deliverd to your doorstep
          </p>
        </div>
      </div>
      {/* Right Side */}
      <div className="flex-1 flex-center px-4 py-12 bg-app-cream">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-app-light">
              {isLoginState
                ? "Don't have an account?"
                : "Already have an account?"}
              <button
                onClick={() => setIsLoginState(!isLoginState)}
                className="text-orange-500 ml-1 font-semibold hover:text-orange-600 transition-colors cursor-pointer hover:underline"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="text-sm flex flex-col gap-1">
              Password
              <div className="relative">
                <KeyIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-app-text-light" />
                <input
                  type="password"
                  value={password}
