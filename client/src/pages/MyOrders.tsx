      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-2 font-medium rounded-xl whitespace-nowrap transition-colors ${activeTab === tab ? "bg-app-green text-white" : "bg-white border border-app-green text-app-text-light hover:bg-app-cream"}`}
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <Link
              to="/products"
              className="bg-app-green text-white px-6 py-3 rounded-xl hover:bg-app-green-dark transition-colors"
            >
              Start Shopping
            </Link>
          </div>
